...
@elseif ($hasChildren)
    <li x-data="{ open: @js($childActive) }">
        ...
        <ul x-show="open" x-collapse x-cloak class="mt-0.5 space-y-0.5">
    ...
    <li>
        ...
        >
            ...
            @if ($item['target'] === '_blank')
                <svg class="size-3 shrink-0 opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
