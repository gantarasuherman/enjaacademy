...
class RolePermissionSeeder extends Seeder
{
    ...
    private array $modules = [
        ...
        'vocabulary-words' => ['view', 'create', 'update', 'delete'],
    ...
    private array $rolePermissions = [
        'Admin' => [
            ...
            'vocabulary-words.*',
            'flashcards.*', 'achievements.*', 'enrollments.*', 'orders.view', 'reports.*', 'audit-logs.view', 'backups.*',
        ],
        'Teacher' => [
            ...
            'vocabulary-words.view', 'vocabulary-words.create', 'vocabulary-words.update',
